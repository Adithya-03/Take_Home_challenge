...
def export_project_as_gist(request, project_id):
    ...
    pending_todos = [todo for todo in project.todos.all() if todo.status == False]
    completed_todos = [todo for todo in project.todos.all() if todo.status == True]
    print(pending_todos)
    ...
    # github_token = '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'
